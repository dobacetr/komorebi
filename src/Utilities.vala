...
namespace Komorebi.Utilities {
	...
	void readWallpaperFile () {
		...
		var wallpaperPath = @"$(Environment.get_home_dir())/Komorebi/System/Resources/Komorebi/$wallpaperName";
		...
		if(wallpaperName == null || !File.new_for_path(wallpaperPath).query_exists() ||
			...
			wallpaperName = "foggy_sunny_mountain";
			wallpaperPath = @"$(Environment.get_home_dir())/Komorebi/System/Resources/Komorebi/$wallpaperName";
