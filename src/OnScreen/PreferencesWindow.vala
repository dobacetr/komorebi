...
namespace Komorebi.OnScreen {
	...
	public class PreferencesWindow : Gtk.Window {
		...
		public PreferencesWindow (string selectedTab = "preferences") {
			...
			aboutGrid.attach(new Image.from_file(@"$(Environment.get_home_dir())/Komorebi/System/Resources/Komorebi/komorebi.svg"), 0, 0, 1, 1);
			...
			bottomWallpapersBox.add(new Image.from_file(@"$(Environment.get_home_dir())/Komorebi/System/Resources/Komorebi/info.svg"));
