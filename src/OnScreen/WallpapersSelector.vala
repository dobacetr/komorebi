...
namespace Komorebi.OnScreen {
	...
	public class WallpapersSelector : ScrolledWindow {
		...
		public string path = @"$(Environment.get_home_dir())/Komorebi/System/Resources/Komorebi/";
		...
		public void getWallpapers () {
			...
			File wallpapersFolder = File.new_for_path(@"$(Environment.get_home_dir())/Komorebi/System/Resources/Komorebi");
			...
			try {
				...
				print(@"Could not read directory '$(Environment.get_home_dir())/Komorebi/System/Resources/Komorebi/'");
			}
		}
