		...
		void setWallpaper() {
			...
			if(enableVideoWallpapers) {
				...
				if(wallpaperType == "video") {
					...
					var videoPath = @"file://$(Environment.get_home_dir())/Komorebi/System/Resources/Komorebi/$wallpaperName/$videoFileName";
			...
			wallpaperPixbuf = new Gdk.Pixbuf.from_file_at_scale(@"$(Environment.get_home_dir())/Komorebi/System/Resources/Komorebi/$wallpaperName/wallpaper.jpg",
