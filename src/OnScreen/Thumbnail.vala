...
namespace Komorebi.OnScreen {
	...
	private class Thumbnail : EventBox {
		...
		Image borderImage = new Image.from_file(@"$(Environment.get_home_dir())/Komorebi/System/Resources/Komorebi/thumbnail_border.svg");
		...
		public Thumbnail.Add() {
			...
			thumbnailImage.pixbuf = new Gdk.Pixbuf.from_file_at_scale(@"$(Environment.get_home_dir())/Komorebi/System/Resources/Komorebi/thumbnail_add.svg", 150, 100, false);
